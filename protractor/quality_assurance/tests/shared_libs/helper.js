...
Helper.prototype.elementIsPresenceDom = function (element) {
  browser.wait(until.presenceOf(element), 200000, 'Element ' + element.getText() + ' taking too long to appear in the DOM')
...
Helper.prototype.elementIsClickable = function (element) {
  browser.wait(until.elementToBeClickable(element), 200000, 'Element taking too long to appear in the DOM and stay clickable')
}

// Wait to see if element is visible
Helper.prototype.elementIsVisible = function (element) {
  browser.wait(until.visibilityOf(element), 2000000, 'Element taking too long to appear in the DOM and stay visible')
}
